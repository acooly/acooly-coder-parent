...
### 5.2.0-SNAPSHOT.20221113

* 2022-11-13 - Issues#11：支持配置列是否查询条件，列表，编辑，显示，导出等功能 - [zhangpu] fd22c05
* 2022-11-13 - 优化list页面的缩进 - [zhangpu] 5933f1e
* 2022-11-12 - Issues#13：生成的area文本域应集成文字倒数 - [zhangpu] 3f1011f
* 2022-11-12 - ISSUE#14:修正show界面输出的空值错误BUG（在日期和枚举为空时）。 - [zhangpu] a5a48b5
