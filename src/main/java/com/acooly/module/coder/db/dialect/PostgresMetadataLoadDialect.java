 ...
 *
 */
public class PostgresMetadataLoadDialect implements MetadataLoadDialect {

	private static final Logger logger = LoggerFactory.getLogger(PostgresMetadataLoadDialect.class);
	...
	public PostgresMetadataLoadDialect(JdbcTemplate jdbcTemplate) {
		super();
