    ...
    <form id="manage_customer_editform"  class="form-horizontal" action="/manage/coder/demo1/customer/<#if action=='create'>saveJson<#else>updateJson</#if>.html" method="post">
        ...
        <div class="card-body">
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<input type="text" name="age" placeholder="请输入年龄..." class="easyui-validatebox form-control" data-inputmask="'alias':'integer'" data-mask  style="height: 30px;width: 260px;line-height: 1.3em;" data-options="validType:['number[0,127]']">
				</div>
			</div>
			<div class="form-group row">
			...
			<div class="form-group row">
				...
				<div class="col-sm-4">
					<select name="idcardType" class="form-control select2bs4"> <#list allIdcardTypes as k,v><option value="${k}">${v}</option></#list> </select>
				</div>
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<select name="customerType" class="form-control select2bs4"> <#list allCustomerTypes as k,v><option value="${k}">${v}</option></#list> </select>
				</div>
			</div>
			<div class="form-group row">
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<select name="numStatus" class="form-control select2bs4"> <#list allNumStatuss as k,v><option value="${k}">${v}</option></#list> </select>
				</div>
			</div>
			<div class="form-group row">
