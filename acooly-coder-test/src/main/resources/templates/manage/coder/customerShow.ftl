<div class="card-body">
	<dl class="row">
		...
		<dd class="col-sm-9">${customer.birthday?string('yyyy-MM-dd')}</dd>
		<dt class="col-sm-3">性别:</dt>
		<dd class="col-sm-9">${customer.gender.message()}</dd>
		<dt class="col-sm-3">生肖:</dt>
		<dd class="col-sm-9">${customer.animal.message()}</dd>
		...
		<dd class="col-sm-9">${customer.doneRatio}</dd>
		<dt class="col-sm-3">薪水:</dt>
		<dd class="col-sm-9">${customer.salary}</dd>
		<dt class="col-sm-3">注册渠道:</dt>
		<dd class="col-sm-9">${customer.registryChannel.message()}</dd>
		<dt class="col-sm-3">推送广告:</dt>
		<dd class="col-sm-9">${customer.pushAdv.message()}</dd>
		<dt class="col-sm-3">数字类型:</dt>
		<dd class="col-sm-9">${allNumStatuss?api.get(customer.numStatus)}</dd>
		<dt class="col-sm-3">状态:</dt>
		<dd class="col-sm-9">${customer.status.message()}</dd>
		...
		<dd class="col-sm-9">${customer.website}</dd>
	</dl>
</div>
