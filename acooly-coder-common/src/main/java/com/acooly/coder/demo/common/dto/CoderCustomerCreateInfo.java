...
@Getter
@Setter
public class CoderCustomerCreateInfo extends InfoBase {
    /**
     * 用户名
     */
    @NotBlank
     ...
     * 生日
     */
    @OpenApiField(desc = "birthday", constraint = "生日", demo = "2023-06-16", ordinal = 2)
    private Date birthday;
    /**
     * 年龄
     */
    @OpenApiField(desc = "age", constraint = "年龄", demo = "1", ordinal = 3)
    private Integer age;
    /**
     * 性别
     */
    ...
    @NotBlank
    @Size(max = 48)
    @OpenApiField(desc = "bankCardNo", constraint = "银行卡卡号", demo = "667688929983998701", ordinal = 9)
     ...
     * 客户类型
     */
    @OpenApiField(desc = "customerType", constraint = "客户类型", demo = "normal", ordinal = 12)
    private CustomerTypeEnum customerType;
    /**
     * 摘要
     */
    @Size(max = 128)
    @OpenApiField(desc = "subject", constraint = "摘要", demo = "9KvJ1tm7uguVx1dzvUitGtT5yMYymLBt", ordinal = 13)
     ...
     * 完成度
     */
    @OpenApiField(desc = "doneRatio", constraint = "完成度", demo = "10", ordinal = 15)
    private Integer doneRatio;
    /**
     * 付款率
     */
    @OpenApiField(desc = "payRate", constraint = "付款率", demo = "90.50", ordinal = 16)
    private Money payRate;
    /**
     * 薪水
     */
    @OpenApiField(desc = "salary", constraint = "薪水", demo = "100.00", ordinal = 17)
    private Money salary;
    /**
     * 注册渠道
     */
    @OpenApiField(desc = "registryChannel", constraint = "注册渠道", demo = "WECHAT", ordinal = 18)
    private ChannelEnum registryChannel;
    /**
     * 推送广告
     */
    @OpenApiField(desc = "pushAdv", constraint = "推送广告", demo = "yes", ordinal = 19)
    private WhetherStatus pushAdv;
    /**
     * 数字类型
     */
    @OpenApiField(desc = "numStatus", constraint = "数字类型", demo = "1", ordinal = 20)
    private Integer numStatus;
    /**
     * 网址
     */
    @Size(max = 128)
    @OpenApiField(desc = "website", constraint = "网址", demo = "https://acooly.cn", ordinal = 21)
    private String website;
    /**
     * 照片
     */
    @Size(max = 128)
    @OpenApiField(desc = "photoPath", constraint = "照片", demo = "/aaa/bbb/ccc.png", ordinal = 22)
    private String photoPath;
    /**
     * 状态
     */
    @NotNull
    @OpenApiField(desc = "status", constraint = "状态", demo = "enable", ordinal = 23)
    private SimpleStatus status;
    /**
     * 备注
     */
    @Size(max = 255)
    @OpenApiField(desc = "comments", constraint = "备注", demo = "JuQDgo13lpiNdrJO6UaHPuOaYpzBbqI8", ordinal = 24)
